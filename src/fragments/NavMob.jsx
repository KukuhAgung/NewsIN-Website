...
const NavMob = ({ Navtransform }) => {
  const position = Navtransform ? "right-0" : "right-[200%]";
  return (
    <div
      className={`relative h-[65vh] w-full bg-white my-8 flex flex-col gap-y-6 z-1 p-4 rounded-lg border shadow-md ${position}`}
    >
